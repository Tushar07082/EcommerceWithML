...
import { NewProductViewedRequestBody, NewUserRequestBody } from "../types/types.js";
...
const createCsv= async(_id: string) =>{
...
const setRecommendations=async (_id:string)=>{
...
export const newlyViewedProduct = TryCatch(
  async (
    req: Request<{}, {}, NewProductViewedRequestBody>,
    res: Response,
    next: NextFunction
  ) => {
